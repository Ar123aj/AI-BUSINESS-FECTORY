...
VARIANT_ID = os.getenv("VARIANT_ID_DIGITAL")

def find_clients():
    print("[Digital-Agent] Searching for digital product buyers...")

def deliver_service(client_query):
    print(f"[Digital-Agent] Creating eBook/course/template for {client_query}...")
